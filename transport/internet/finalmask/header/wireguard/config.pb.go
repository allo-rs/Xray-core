...
const file_transport_internet_finalmask_header_wireguard_config_proto_rawDesc = "" +
	...
	"\x06ConfigB\xbb\x01\n" +
	"6com.xray.transport.internet.finalmask.header.wireguardP\x01ZJgithub.com/allo-rs/Xray-core/transport/internet/finalmask/header/wireguard\xaa\x022Xray.Transport.Internet.Finalmask.Header.Wireguardb\x06proto3"
