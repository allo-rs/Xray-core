...
const file_transport_internet_finalmask_header_custom_config_proto_rawDesc = "" +
	...
	"\x06server\x18\x02 \x03(\v28.xray.transport.internet.finalmask.header.custom.UDPItemR\x06serverB\xb2\x01\n" +
	"3com.xray.transport.internet.finalmask.header.customP\x01ZGgithub.com/allo-rs/Xray-core/transport/internet/finalmask/header/custom\xaa\x02/Xray.Transport.Internet.Finalmask.Header.Customb\x06proto3"
