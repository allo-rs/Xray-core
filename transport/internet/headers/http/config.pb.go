...
const file_transport_internet_headers_http_config_proto_rawDesc = "" +
	...
	"(com.xray.transport.internet.headers.httpP\x01Z9github.com/allo-rs/Xray-core/transport/internet/headers/http\xaa\x02$Xray.Transport.Internet.Headers.Httpb\x06proto3"
