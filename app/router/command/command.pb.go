...
import (
	net "github.com/allo-rs/Xray-core/common/net"
	serial "github.com/allo-rs/Xray-core/common/serial"
...
const file_app_router_command_command_proto_rawDesc = "" +
	...
	"\bListRule\x12(.xray.app.router.command.ListRuleRequest\x1a).xray.app.router.command.ListRuleResponse\"\x00Bj\n" +
	"\x1bcom.xray.app.router.commandP\x01Z/github.com/allo-rs/Xray-core/app/router/command\xaa\x02\x17Xray.App.Router.Commandb\x06proto3"
